...
pub mod ffi {
    ...
    extern "Rust" {
        ...
        fn on_capture_result(self: &DesktopCapturerCallbackWrapper, frame: UniquePtr<DesktopFrame>);
    }
}
...
pub trait DesktopCapturerCallback: Send {
    fn on_capture_result(&self, frame: UniquePtr<DesktopFrame>);
}
...
impl DesktopCapturerCallbackWrapper {
    ...
    fn on_capture_result(&self, frame: UniquePtr<DesktopFrame>) {
        self.callback.on_capture_result(frame);
    }
}
